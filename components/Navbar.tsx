        ...
        >
            <div className="container mx-auto px-6 md:px-12 flex items-center justify-between gap-6">
                ...
                <nav className="hidden md:flex items-center gap-6 shrink-0">
                    <Link href="/store" className="text-sm font-medium text-gray-600 hover:text-pink-600 transition-colors">Categories</Link>
                ...
                {mobileMenuOpen && (
                    ...
                    >
                        <div className="px-6 py-4 flex flex-col gap-4">
                            ...
                            <Link href="/store" onClick={() => setMobileMenuOpen(false)} className="text-lg font-medium text-gray-700 hover:text-pink-600">Categories</Link>
