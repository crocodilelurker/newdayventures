        ...
        <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-1.5">
                            ...
                            <button type="button" className="text-xs text-pink-500 hover:text-pink-600 font-medium transition-colors">
                                Forgot password?
                            </button>
                        </div>
                        <div className="relative">
                ...
                <p className="text-center text-sm text-gray-500 mt-8">
                    ...
                    <Link href="/signup" className="text-pink-500 hover:text-pink-600 font-semibold transition-colors">
                        Sign up
                    </Link>
                </p>
            </motion.div>
